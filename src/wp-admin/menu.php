...
if ( ! is_multisite() ) {
	...
	/* add_action( 'admin_menu', '_add_themes_utility_last', 101 ); -- removed in 7.2.0 */
}
/**
 ...
 */
/* Theme File Editor and Plugin File Editor menus removed in 7.2.0. */
...
if ( ! is_multisite() ) {
	...
	/* Plugin File Editor menu removed in 7.2.0. */
}
