<?php
/**
 * Class MySqlDialect — DatabaseDialect implementation for MySQL 8.4+
 * and the maintained newer LTS (currently 9.7).
 *
 * Vendor detection happens in wpdb::db_connect(); this class is
 * instantiated only when the connected engine is MySQL.
 *
 * @package WordPress
 */
